...
list_seq1 = ["A1", "B1", "C1", "D1", "E1"]
list_seq2 = ["A0", "B0", "C0", "D0"]
...
def main():
    ...
    print("dataset_combine ", len(dataset_combine))
    
    dataloader = DataLoader(dataset_combine, batch_size=256, shuffle=True)
    ...
    dataloader_val = DataLoader(dataset_combine, batch_size=256, shuffle=True)
    ...
    dataset_combine = dataset_eval + dataset_eval2
    print("dataset_combine ", len(dataset_combine))
    
    dataloader_eval = DataLoader(dataset_combine, batch_size=256, shuffle=True)
    ...
    model = ExpertClassifier(input_dim=256, num_experts=9).to(device)
    ...
    model_name = "expert_gate_est_ouest.pth"
