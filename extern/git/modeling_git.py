...
class GitLidarModel(GitPreTrainedModel):
    ...
    def forward(
        ...
        if desc_from_logg == False:
            ...
            #nn = lidar_values[input_mod][0]
            #xx_sop_log3d = self.load_tensor_just_one(nn,"logg_desc") 
            #xx_sop_log3d = lidar_values[input_mod+'_desc'][0]
            xx_final_ori = lidar_values[input_mod+'_desc'][0]
        else:
            print("todo")
            # todo , call logg3dnet.py
        ...
        return (lidar_values, xx_final)
        #return (lidar_values, xx_sop_log3d)
...
class GitModel(GitPreTrainedModel):
    ...
    def forward(
        ...
        projected_visual_features = projected_visual_features.repeat(embedding_output.size(0) // projected_visual_features.size(0), 1, 1) # more gpu friendly
