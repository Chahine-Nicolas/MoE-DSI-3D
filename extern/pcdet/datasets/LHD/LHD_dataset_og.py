        ...
        if "points" in get_item_list:
            ...
            if self.tokenizer:
                ...
                input_dict.update({
                    ...
                    'id_pcd_positif':  [ str(os.path.basename(sel_positive_ids[0])).split('/')],
                    'id_pcd_negatif':  [ str(os.path.basename(sel_negative_ids[0])).split('/')],
                    'other_id_pcd_negatif':  [str(os.path.basename(other_neg_id)).split('/') ]
                })
