...
def main():
    ...
    train_indicese = load_training_set_ids("id_zone_E_dsi_train_list.json", "id_zone_E_dsi_val_list.json")  

    all_train_indices = train_indicesa + train_indicesb + train_indicesc + train_indicesd + train_indicese
    ...
    name_train_indicese = load_training_set_ids("zone_E_dsi_train_list.json", "zone_E_dsi_val_list.json")
    ...
    eval_name_e = load_set_ids("zone_E_dsi_eval_list.json", sequence_path)
    ...
    """
    checkpoint_paths = ["/lustre/fswork/projects/rech/dki/ujo91el/checkpoints/git_hilbert_train_A1/checkpoint-4100/pytorch_model.bin",
    ...
    class Top2Gating(nn.Module):
        def __init__(
            ...
            self.gate = ExpertClassifier(input_dim=256, num_experts=5)
            ...
            self.gate.load_state_dict(torch.load("expert_gate_ouest0.pth"))
    ...
    class MoE_DSI(nn.Module):
        def __init__(self, input_dim, experts, tokenizer, expert_labels):
            ...
            self.gate = Top2Gating(256, num_gates = 5, **gating_kwargs)
    ...
    if do_eval  : 
        ...
        #eval_indices = all_eval_indices.sort()

        all_eval_indices.sort()
